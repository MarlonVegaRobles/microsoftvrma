...
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/config/database.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/app/models/Persona.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/app/models/Sexo.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/app/models/Estadocivil.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/app/models/Direccion.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/microsoftvrma/app/models/Telefono.php';
