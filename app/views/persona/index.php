...
<head>
    ...
    <link rel="stylesheet" href="/microsoftvrma/public/css/style.css">
</head>
<body>

<div class="container">
    <h1>Lista de Personas</h1>
    <a href="/microsoftvrma/public/persona/create"><button>Agregar</button></a>
                ...
                <?php foreach ($personas as $persona): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($persona['elsexo']); ?></td> <td><?php echo htmlspecialchars($persona['elestadocivil']); ?></td> <td>
                            <a href="/microsoftvrma/public/persona/view?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>View</button>
                            </a>
                            <a href="/microsoftvrma/public/persona/edit?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/microsoftvrma/public/persona/deleteForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>"
...
<script src="/microsoftvrma/public/js/script.js"></script>
</body>
</html>
